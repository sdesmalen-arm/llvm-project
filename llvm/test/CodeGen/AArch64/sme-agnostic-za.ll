...
; Use regular DYNAMIC_STACKALLOC for allocation, prevents alloca from being removed entirely.
define i64 @agnostic_caller_no_callees_stackprobe(ptr %ptr) nounwind "aarch64_za_state_agnostic" "probe-stack"="inline-asm" {
; CHECK-LABEL: agnostic_caller_no_callees_stackprobe:
; CHECK:       // %bb.0:
